 ...
 * <p>
 * This class provides a dedicated map from integers to doubles with a much
 * smaller memory overhead than standard <code>java.util.Map</code>.</p>
 * <p>
...
public class OpenLongToDoubleHashMap implements Serializable {
     ...
     * <p>
     * This must be a power of two for bit mask to work properly. </p>
     */
    ...
    /**
     * Build an empty map with default size and using 0 for missing entries.
     */
    public OpenLongToDoubleHashMap() {
        this(DEFAULT_EXPECTED_SIZE, 0);
    }
    ...
    /**
     * Build an empty map with specified size and using 0 for missing entries.
     *
